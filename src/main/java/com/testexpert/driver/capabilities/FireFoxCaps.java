 ...
 */
public class FireFoxCaps extends TestExpertCaps {
     ...
     *{@link <a href="com.testexpert.driver.capabilities.TestExpertCaps.get()"/>}
     */
    ...
    /**This method is to get firefoxOptions
     * @return firefoxOptions
     */
    private FirefoxOptions getFirefoxOptions() {
        FirefoxOptions options = new FirefoxOptions();
        options.setCapability(CapabilityType.UNEXPECTED_ALERT_BEHAVIOUR, this.alertBehaviour);
        options.setCapability(Capability.MARIONETTE, false);
        options.setCapability(Capability.PROFILE, createFirefoxProfile());
    ...
    /**
     * This method is to set firefox preferences 
